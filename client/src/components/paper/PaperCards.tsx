...
export default function PaperCards() {
  ...
  const createOrderEntry = (paper: Paper) => {
    const quantity = quantities[paper.id!] || 0;
    ...
    setQuantities((prev) => ({ ...prev, [paper.id!]: 0 }));
  };
  ...
  return (
    <>
      <div className="bg-gray-50 min-h-screen pt-32 p-5">
        {" "}
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        handleQuantityChange(event, paper.id!)
                      }
                    />
