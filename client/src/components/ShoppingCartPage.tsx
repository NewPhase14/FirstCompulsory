        ...
        <>
            ...
            <div className="flex h-screen bg-gray-50 pt-32 p-5">
                ...
                <div className="w-full md:w-1/2 max-w-lg mx-auto my-10 overflow-auto">
                    ...
                    <p className="text-gray-600 mb-2">You have {orderEntry.length} items in your cart</p>
                    {orderEntry.map((oe) => (
                        <div key={oe.id} className="p-4 bg-white shadow rounded-lg flex items-center justify-between my-4">
                            <img src={oe.product?.picture!} alt="Product" className="w-16 h-16 rounded-md object-cover" />
                            <div className="ml-4 flex-grow">
                                <h2 className="text-lg font-semibold text-gray-800">{oe.product?.name}</h2>
                            ...
                            <div className="ml-4">
                                <span className="text-lg font-medium">${(oe.quantity! * oe.product?.price!).toFixed(2)}</span>
                            </div>
                        </div>
                    ))}
                </div>
