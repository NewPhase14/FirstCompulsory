  ...
  return (
      <div className="navbar shadow-lg bg-gray-100 fixed w-full z-10 p-4">
        ...
        <div className="navbar-center">
          <Link to="/" className="nav-link mx-4 text-gray-800 hover:text-blue-600">Home</Link>
          <Link to="/product" className="nav-link mx-4 text-gray-800 hover:text-blue-600">Products</Link>
        </div>
          ...
          <div className="dropdown dropdown-end">
            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle relative">
              <div className="indicator">
                ...
                <span className="badge badge-sm indicator-item bg-blue-600 text-white">{orderEntries.length}</span>
              </div>
            </div>
            <div
                tabIndex={0}
            ...
            >
              <div className="card-body p-4">
                <span className="text-lg font-bold text-gray-800">{orderEntries.length} Items</span>
                <span className="text-gray-600">Subtotal: ${getTotalCost()}</span>
                <div className="card-actions">
                  <Link to={"/shoppingcart"}>
                    <button className="btn btn-primary btn-block bg-blue-600 hover:bg-blue-700 text-white rounded-md transition duration-200 ease-in-out">View cart</button>
                  </Link>
                </div>
              </div>
            </div>
          ...
          <div className="dropdown dropdown-end">
            ...
            >
              <li className="hover:bg-gray-200 transition-colors duration-200 ease-in-out">
                <Link to="/order" className="justify-between text-gray-800">Order History</Link>
              </li>
              <li className="hover:bg-gray-200 transition-colors duration-200 ease-in-out">
                <Link to="/management" className="text-gray-800">Product Management</Link>
              </li>
            </ul>
          </div>
        </div>
